  ...
  return (
    <footer className="relative  text-gray-300  ">
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        <Link href="https://github.com/adityarauniyar-ux/IntervueAI" >
        < Github />
        </Link>
      ...
      <div className="mt-4 px-6 flex flex-col md:flex-row items-center justify-between text-sm text-gray-600">
        ...
        <Link href="https://www.linkedin.com/in/aditya-runiyar-762618297/" className="hover:underline">LinkedIn</Link>
          <Link href="https://github.com/adityarauniyar-ux" className="hover:underline">GitHub</Link>
          <Link href="mailto:adityarauniyar.tech@gmail.com" className="hover:underline">Contact Us</Link>
        </div>
        <div>
